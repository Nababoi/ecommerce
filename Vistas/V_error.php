...
<head>
  ...
  <title>Amor & Moda - Problemas Tecnicos</title>
  <!-- bootstrap -->
...
<body>
    ...
    <div class="container">
        <h1>Disculpe, Estamos Experimentando Problemas Técnicos</h1>
        <p>Estamos trabajando para resolver el problema lo más pronto posible. Por favor, vuelva a visitarnos más tarde.</p>
    </div>
